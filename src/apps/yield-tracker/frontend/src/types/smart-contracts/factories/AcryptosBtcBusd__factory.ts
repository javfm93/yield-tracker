...
import type { AcryptosBtcBusd } from "../AcryptosBtcBusd";

export class AcryptosBtcBusd__factory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AcryptosBtcBusd {
    return new Contract(address, _abi, signerOrProvider) as AcryptosBtcBusd;
  }
}
